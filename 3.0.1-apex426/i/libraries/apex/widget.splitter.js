    ...
    $.widget( "apex.splitter", {
        ...
        _create: function () {
            ...
            if ( ctrl$.children().length !== 2 ) {
                throw "Splitter must have exactly two children.";
            }
            if ( o.orientation !== "horizontal" && o.orientation !== "vertical") {
                throw "Orientation bad value";
            }
            if ( o.positionedFrom !== "begin" && o.positionedFrom !== "end") {
                throw "PositionedFrom bad value";
            }
            ...
            if ( ctrl$.parent( SEL_SPLITTER ).length > 0 || this.before$.is( SEL_SPLITTER ) || this.after$.is ( SEL_SPLITTER )) {
                throw "Child of splitter cannot be a splitter";
            }
            if ( !this.before$[0].id ) {
        ...
        _eventHandlers: {
            resize: function( event ) {
                ...
                w = ctrl$.width();
                if ( h === 0 || w === 0 ) {
                    throw "Splitter needs to be in a component with size";
                }
