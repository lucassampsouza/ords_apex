"function"!=typeof Object.create&&(Object.create=function(){function F(){}return function(o){if(1!==arguments.length)throw new Error("This Object.create implementation only accepts one parameter.");return F.prototype=o,new F}}());var apex={};apex.jQuery=jQuery,function($){"use strict";apex.gPageContext$=$(document),apex.gParentPageContext$=apex.gPageContext$,$(document).on("pagebeforecreate pageshow",function(pEvent){var lNewPageContext$=$(pEvent.target);"dialog"===lNewPageContext$.data("role")?apex.gPageContext$=1===lNewPageContext$.has("[role='listbox']").length?apex.gParentPageContext$:$(pEvent.target):(apex.gPageContext$=$(pEvent.target),apex.gParentPageContext$=apex.gPageContext$)}),$(document).on("pageshow",function(pEvent){var lData=$(pEvent.target).data();lData.apexPageTransition&&($.mobile.defaultPageTransition=lData.apexPageTransition),lData.apexPopupTransition&&($.mobile.defaultDialogTransition=lData.apexPopupTransition)});var resizeTimerId,lastStoredHeight=0,lastStoredWidth=0;$(window).resize(function(){($(window).height()!=lastStoredHeight||$(window).width()!=lastStoredWidth)&&(lastStoredHeight=$(window).height(),lastStoredWidth=$(window).width(),resizeTimerId&&clearTimeout(resizeTimerId),resizeTimerId=setTimeout(function(){$(window).trigger("apexwindowresized"),resizeTimerId=null},200))});var ie_upto10=/MSIE \d/.test(navigator.userAgent),ie_11up=/Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent),ie=ie_upto10||ie_11up,ie_version=ie&&(ie_upto10?document.documentMode||7:ie_11up[1]);7===ie_version?$("html").addClass("ie7 lt-ie8 lt-ie9 lte-ie9 lte-ie10"):8===ie_version?$("html").addClass("ie8 lt-ie9 lte-ie9 lte-ie10"):9===ie_version?$("html").addClass("ie9 lte-ie9 lte-ie10"):10===ie_version&&$("html").addClass("ie10 lte-ie10")}(apex.jQuery);
